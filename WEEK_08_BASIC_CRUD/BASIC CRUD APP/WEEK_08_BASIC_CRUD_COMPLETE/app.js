...
//we will be using the express module to create our server
var express = require('express');
//to be able to decipher post reqs
var bodyParser = require('body-parser');
//assign our "server" to a variable called "app"
var app = express();
//THE 'FS' module is a inbuilt node module (doesn') to read and write files on your computer
//We will be using this to read and write a JSON file that will act as our Database
var fs = require('fs');
